...
export access_token=$(\
   curl -s -X POST http://localhost:8081/auth/realms/demo_realm/protocol/openid-connect/token \
...
export response=$(curl -s -o /dev/null -w "%{http_code}" -X GET http://localhost:8080/api/request/user -H "Authorization: Bearer "$access_token)
if [ $response -eq 200 ]
then
...
echo -e "Response : "$(curl -s -X GET http://localhost:8080/api/request/user -H "Authorization: Bearer "$access_token)"\033[0m"

echo -e "---------------------------------------------------"

echo -e "\033[7mTest admin role to access /api/admin \033[0m"
export response=$(curl -s -o /dev/null -w "%{http_code}" -X GET http://localhost:8080/api/request/admin -H "Authorization: Bearer "$access_token)
if [ $response -eq 200 ]
then
echo -e "\033[102mResponse code: "$response
else
...
#echo -e "\033[101mResponse code: "$(curl -s -o /dev/null -w "%{http_code}" -X GET http://localhost:8080/api/request/admin -H "Authorization: Bearer "$access_token)"\033[0m"
echo -e "Response : "$(curl -s -X GET http://localhost:8080/api/request/admin -H "Authorization: Bearer "$access_token)"\033[0m"
...
#echo -e "\033[102mResponse code: "$(curl -s -o /dev/null -w "%{http_code}" -X GET http://localhost:8080/api/request/user -H "Authorization: Bearer "$access_token)"\033[0m"
echo -e "Response : "$(curl -s -X GET http://localhost:8080/api/request/user -H "Authorization: Bearer "$access_token)"\033[0m"
...
#echo -e "\033[103mResponse code: "$(curl -s -o /dev/null -w "%{http_code}" -X GET http://localhost:8080/api/request/admin -H "Authorization: Bearer "$access_token)"\033[0m"
echo -e "Response : "$(curl -s -X GET http://localhost:8080/api/request/admin -H "Authorization: Bearer "$access_token)"\033[0m"
